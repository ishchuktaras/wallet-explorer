...
import type { Asset, AssetDetail, NFTCardProps, NFTDisplayProps, ViewMode } from "@/lib/types";
import { motion } from "framer-motion";
import { NFTMetadata, NFTDetailDialogProps } from "@/lib/types";
...
function NFTCard({
  ...
  const metadata = (nftDetails?.onchain_metadata ||
    nftDetails?.metadata ||
    {}) as NFTMetadata;
  ...
  const handleImageError = (
    ...
    ).src = `data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 400' fill='%23cccccc'%3E%3Crect width='400' height='400' /%3E%3Ctext x='50%25' y='50%25' dominantBaseline='middle' textAnchor='middle' fontFamily='sans-serif' fontSize='24px' fill='%23ffffff'%3ENo Image%3C/text%3E%3C/svg%3E`;
  };
        ...
        >
          ...
          <CardContent className="p-4">
            <div className="space-y-2">
              <h3
                className="font-bold text-lg text-teal-800 dark:text-teal-300 truncate"
                title={name}
              >
                {name}
              </h3>
...
function NFTDetailDialog({ open, onOpenChange, nft }: NFTDetailDialogProps) {
  ...
  const metadata =
    details?.onchain_metadata || details?.metadata || ({} as NFTMetadata);
            ...
            <div className="rounded-lg overflow-hidden border-2 border-teal-200 dark:border-teal-800 shadow-lg">
              ...
              <img
                ...
                onError={(e) => {
                  (
                    e.target as HTMLImageElement
                  ).src = `data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 600 600' fill='%23cccccc'%3E%3Crect width='600' height='600' /%3E%3Ctext x='50%25' y='50%25' dominantBaseline='middle' textAnchor='middle' fontFamily='sans-serif' fontSize='32px' fill='%23ffffff'%3ENo Image%3C/text%3E%3C/svg%3E`;
                }}
              />
            </div>
